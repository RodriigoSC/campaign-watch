        ...
        public async Task<IEnumerable<EffpushRead>> GetTriggerEffpush(string dbName, string workflowId)
        {
            ...
            var pipeline = new BsonDocument[]
            {
                    ...
                    { "pipeline", new BsonArray
                        {
                            ...
                            {
                                { "_id", "$LastStatus" }, // Usando LastStatus para Push
                ...
                new BsonDocument("$project", new BsonDocument
                {
                    ...
                    { "ModifiedAt", 1 }, { "TemplateId", 1 }, { "WebhookEnabled", 1 },
            ...
            var aggregation = await triggerCollection.Aggregate<EffpushRead>(pipeline).ToListAsync();
            return aggregation;
        }
    }
}